...
const foundersData = [
  ...
  },
  {
    name: "Rizqi Zaidan",
    photo: photoRizqi,
    role: "UX Strategist & Communicator"
  }
];
    ...
    <section id="founders" className="py-16 md:py-24 bg-gradient-to-br from-gray-700 to-gray-900 text-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16">
          Tim di Balik <span className="text-yellow-300">KuickTech</span> 
        </h2>
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 text-center">
          {foundersData.map((founder, index) => (
            <div key={index} className="flex flex-col items-center p-6 bg-gray-800/50 rounded-xl shadow-xl backdrop-blur-sm group"> {/* Tambahkan 'group' untuk hover effect jika mau */}
              {/* BAGIAN YANG DIGANTI: Gunakan <img> untuk menampilkan foto */}
              <img 
                src={founder.photo} 
              ...
              />
              {/* Placeholder inisial yang sebelumnya bisa dihapus atau dijadikan fallback jika foto tidak ada */}
              {/* <div className="w-24 h-24 md:w-32 md:h-32 rounded-full mb-4 shadow-lg bg-yellow-300 flex items-center justify-center text-gray-700 text-4xl md:text-5xl font-bold">
        ...
        <p className="text-center mt-12 md:mt-16 text-lg md:text-xl max-w-3xl mx-auto text-gray-300">
          Kami adalah tim yang berdedikasi untuk menciptakan solusi penyewaan teknologi yang lebih efisien, aman, dan dapat diakses oleh semua orang.
        </p>
      </div>
    </section>
  );
